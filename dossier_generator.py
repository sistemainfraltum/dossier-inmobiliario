...
def _build_market(data, content, lang, n):
    ...
    mkt_context    = _ai(content, 'market_context', '')
    mkt_positioning = _ai(content, 'market_positioning', '')
    mkt_opportunity = _ai(content, 'market_opportunity', '')
...
def _build_investment(data, content, lang, n):
    ...
    if precio > 0:
        ...
        W, H, pad_l, pad_r, pad_t, pad_b = 420, 90, 42, 10, 10, 22
        ...
        proj_svg = (
            f'<div style="margin:4mm 0 2mm; background:rgba(251,248,242,0.9); '
            f'border:1px solid rgba(201,168,76,0.28); padding:4mm;">'
